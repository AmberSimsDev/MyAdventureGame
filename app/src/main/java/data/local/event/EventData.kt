...
object EventData {
    ...
    private val describeNormalEvent = arrayListOf(
        "Today is the day your life changes forever as you decide to begin a new adventure in the " +
                "rich, cultural city of Madrid. You make it to your flight with decent seating. No crying baby in sight!",
    ...
    private val describeUnluckyEvent = arrayListOf(
        "Today is the day your life changes forever as you decide to begin a new adventure in the " +
                "rich, cultural city of Madrid. Your flight was delayed, but you finally make it to your seat..." +
